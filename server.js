...
function getDefaultBoard() {
    return [
        { name: "GO", type: "go" },
        { name: "Salvador", type: "property", countryCode: "br", price: 60, rent: [2, 10, 30, 90, 160, 250], color: "#a55a40", houseCost: 50 },
        { name: "Treasure", type: "community_chest" },
        { name: "Rio", type: "property", countryCode: "br", price: 60, rent: [4, 20, 60, 180, 320, 450], color: "#a55a40", houseCost: 50 },
        { name: "Earnings Tax", type: "tax", amount: 200 },
        { name: "TLV Airport", type: "railroad", price: 200 },
        { name: "Tel Aviv", type: "property", countryCode: "il", price: 100, rent: [6, 30, 90, 270, 400, 550], color: "#add8e6", houseCost: 50 },
        { name: "Surprise", type: "chance" },
        { name: "Haifa", type: "property", countryCode: "il", price: 100, rent: [6, 30, 90, 270, 400, 550], color: "#add8e6", houseCost: 50 },
        { name: "Jerusalem", type: "property", countryCode: "il", price: 120, rent: [8, 40, 100, 300, 450, 600], color: "#add8e6", houseCost: 50 },
        { name: "In Prison / Just Visiting", type: "jail" },
        { name: "Venice", type: "property", countryCode: "it", price: 140, rent: [10, 50, 150, 450, 625, 750], color: "#d25298", houseCost: 100 },
        { name: "Power Company", type: "utility", price: 150 },
        { name: "Milan", type: "property", countryCode: "it", price: 140, rent: [10, 50, 150, 450, 625, 750], color: "#d25298", houseCost: 100 },
        { name: "Rome", type: "property", countryCode: "it", price: 160, rent: [12, 60, 180, 500, 700, 900], color: "#d25298", houseCost: 100 },
        { name: "NUC Airport", type: "railroad", price: 200 },
        { name: "Frankfurt", type: "property", countryCode: "de", price: 180, rent: [14, 70, 200, 550, 750, 950], color: "#f7941e", houseCost: 100 },
        { name: "Treasure", type: "community_chest" },
        { name: "Munich", type: "property", countryCode: "de", price: 180, rent: [14, 70, 200, 550, 750, 950], color: "#f7941e", houseCost: 100 },
        { name: "Berlin", type: "property", countryCode: "de", price: 200, rent: [16, 80, 220, 600, 800, 1000], color: "#f7941e", houseCost: 100 },
        { name: "Vacation", type: "free_parking" },
        { name: "Shenzhen", type: "property", countryCode: "cn", price: 220, rent: [18, 90, 250, 700, 875, 1050], color: "#ed1c24", houseCost: 150 },
        { name: "Surprise", type: "chance" },
        { name: "Beijing", type: "property", countryCode: "cn", price: 220, rent: [18, 90, 250, 700, 875, 1050], color: "#ed1c24", houseCost: 150 },
        { name: "Shanghai", type: "property", countryCode: "cn", price: 240, rent: [20, 100, 300, 750, 925, 1100], color: "#ed1c24", houseCost: 150 },
        { name: "CDG Airport", type: "railroad", price: 200 },
        { name: "Lyon", type: "property", countryCode: "fr", price: 260, rent: [22, 110, 330, 800, 975, 1150], color: "#ffeb3b", houseCost: 150 },
        { name: "Toulouse", type: "property", countryCode: "fr", price: 260, rent: [22, 110, 330, 800, 975, 1150], color: "#ffeb3b", houseCost: 150 },
        { name: "Water Company", type: "utility", price: 150 },
        { name: "Paris", type: "property", countryCode: "fr", price: 280, rent: [24, 120, 360, 850, 1025, 1200], color: "#ffeb3b", houseCost: 150 },
        { name: "Go to prison", type: "go_to_jail" },
        { name: "Liverpool", type: "property", countryCode: "gb", price: 300, rent: [26, 130, 390, 900, 1100, 1275], color: "#4caf50", houseCost: 200 },
        { name: "Manchester", type: "property", countryCode: "gb", price: 300, rent: [26, 130, 390, 900, 1100, 1275], color: "#4caf50", houseCost: 200 },
        { name: "Treasure", type: "community_chest" },
        { name: "London", type: "property", countryCode: "gb", price: 320, rent: [28, 150, 450, 1000, 1200, 1400], color: "#4caf50", houseCost: 200 },
        { name: "JFK Airport", type: "railroad", price: 200 },
        { name: "Surprise", type: "chance" },
        { name: "San Francisco", type: "property", countryCode: "us", price: 350, rent: [35, 175, 500, 1100, 1300, 1500], color: "#2196f3", houseCost: 200 },
        { name: "Premium Tax", type: "tax", amount: 100 },
        { name: "New York", type: "property", countryCode: "us", price: 400, rent: [50, 200, 600, 1400, 1700, 2000], color: "#2196f3", houseCost: 200 }
    ];
}
